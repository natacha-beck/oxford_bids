...
######################################################################################################################################################################
####################for all folders in working directory check if the folder's name starts with "anat" or "perf, if yes, means the subjects has only one session, and files need to be found without going inside each folder #####################################################################################################################################################################
...
################################################################################################################
 ...
 break 
#####################################################################################################################################################################
##############################the else condition here is for the first if after the first for, if the files names in the working directory begin with "ses-" means that the subject has different sessions and needs to go inside each folder separately to find files, other lines are repetive, the only difference is that if the first condition "if [[ "$se" =~ 'anat' ]] | [[ "$se" =~ 'perf' ]];" is correct the loop should be executed once, if not, it should be executed for each folder with "ses-"#####
###################################################################################################################################################################
elif [[ "$se" =~ 'ses-' ]];then
